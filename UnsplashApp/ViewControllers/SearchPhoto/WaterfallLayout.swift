...
class WaterfallLayout: UICollectionViewLayout {
    ...
    private var columnWidth: CGFloat {
        ...
        return (collectionViewContentSize.width - (CGFloat(numberOfColumns - 1) *
                                                   itemSpacing)) / CGFloat(numberOfColumns)
    }
    ...
    private func indexOfNextColumn(columnHeights: [CGFloat]) -> Int {
    ...
    override func prepare() {
        ...
        func originForColumn(_ column: Int) -> CGPoint {
            let pointX = isSingleColumn ? 0 : collectionView.layoutMargins.left
            + CGFloat(column) * (columnWidth + itemSpacing)
        ...
        for index in 0 ..< numberOfItems {
            ...
            let columnIndex = indexOfNextColumn(columnHeights: columnHeights)
        ...
        if numberOfItems > 0 {
            ...
            let pagingViewAttributes = UICollectionViewLayoutAttributes(
